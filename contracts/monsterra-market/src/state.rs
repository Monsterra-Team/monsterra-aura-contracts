...
//     pub order_id: MultiIndex<'a, (String, Vec<u8>), Order, u128>,
// }
...
// {
//     // pk goes to second tuple element
//     pub bid_id: MultiIndex<'a, (String, Vec<u8>), Bid, u128>,
// }
...
// {
//     // pk goes to second tuple element
//     pub bundle_id: MultiIndex<'a, (String, Vec<u8>), Bundle, u128>,
// }
...
// {
//     // pk goes to second tuple element
//     pub key: MultiIndex<'a, (String, Vec<u8>, ), CanAccept, u128>,
// }
...
// pub fn can_accept_idx<>(d: &CanAccept, k: Vec<u8>) -> (String, Vec<u8>) {
//     (d.token_address.clone().to_string() + (&d.token_id.clone()) + (&d.owner.clone().to_string()), k)
// }

// pub fn order_idx<>(d: &Order, k: Vec<u8>) -> (String, Vec<u8>) {
//     (d.id.clone(), k)
// }

// pub fn bid_idx<>(d: &Bid, k: Vec<u8>) -> (String, Vec<u8>) {
//     (d.id.clone(), k)
// }

// pub fn bundle_idx<>(d: &Bundle, k: Vec<u8>) -> (String, Vec<u8>) {
//     (d.id.clone(), k)
// }